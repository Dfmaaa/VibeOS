/*
 * TCC for VibeOS - libc implementations
 *
 ...
 * are already defined in vibe.h/crt0.o - we only define extras */
...
/* ============ ctype functions ============ */
/* Note: isspace, isprint are already defined in vibe.h - only define extras */
...
char *realpath(const char *path, char *resolved_path) {
    ...
    /* VibeOS doesn't have symlinks so the path is already "real" */
    if (!path) return 0;
